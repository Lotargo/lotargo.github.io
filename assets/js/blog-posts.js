...
window.BLOG_POSTS = [
  {
    slug: 'blog-launch', date: '2026-06-28', notificationId: '2026-06-28-blog-scaffold',
    href: './blog-launch.html', url: './blog/posts/blog-launch.html',
    type: { en: 'Site architecture', ru: 'Архитектура сайта' },
    title: { en: 'How we added the blog and living updates', ru: 'Как мы добавили блог и живые уведомления' },
    shortTitle: { en: 'Blog scaffold is live', ru: 'Заготовка блога готова' },
    description: {
  ...
  {
    slug: 'arithmetic-overfitting', date: '2026-06-28',
    href: './arithmetic-overfitting.html', url: './blog/posts/arithmetic-overfitting.html',
    type: { en: 'AI stability', ru: 'Стабильность ИИ' },
    title: { en: 'When a Tiny Mamba Learns Arithmetic', ru: 'Когда маленькая Mamba учится арифметике' },
    shortTitle: { en: 'Arithmetic stability article', ru: 'Статья о стабильности арифметики' },
    description: {
  ...
  {
    slug: 'three-sprints', date: '2026-06-29',
    href: './three-sprints.html', url: './blog/posts/three-sprints.html',
    type: { en: 'AI systems', ru: 'AI системы' },
    title: {
    ...
    shortTitle: { en: '1000× Faster Backward Pass', ru: '1000× быстрее backward pass' },
    description: {
  ...
  {
    slug: 'logs-are-not-memory', date: '2026-06-29',
    href: './logs-are-not-memory.html', url: './blog/posts/logs-are-not-memory.html',
    type: { en: 'Research infrastructure', ru: 'Исследовательская инфраструктура' },
    title: { en: 'Logs ≠ Memory: Why Research Projects Need ClickHouse', ru: 'Логи ≠ память: зачем исследовательским проектам ClickHouse' },
    shortTitle: { en: 'Logs ≠ Memory', ru: 'Логи ≠ память' },
    description: {
  ...
  {
    slug: 'gemini-safety-filter-layers', date: '2026-07-08',
    href: './gemini-safety-filter-layers.html', url: './blog/posts/gemini-safety-filter-layers.html',
    type: { en: 'Safety architecture', ru: 'Архитектура safety' },
    title: { en: 'The Filter Matryoshka: Notes on Gemini Safety Layers', ru: 'Матрёшка фильтров: заметки о safety-слоях Gemini' },
    shortTitle: { en: 'The Filter Matryoshka', ru: 'Матрёшка фильтров' },
    notificationTitle: { en: 'Gemini safety layers note', ru: 'Заметка о safety-слоях Gemini' },
    description: {
  ...
  {
    slug: 'testing-web-app-ai-sandbox', date: '2026-07-10',
    href: './testing-web-app-ai-sandbox.html', url: './blog/posts/testing-web-app-ai-sandbox.html',
    type: { en: 'AI-assisted development', ru: 'AI-разработка' },
    title: { en: 'Coding Without Codex: How Far Regular ChatGPT Can Go', ru: 'Код без Codex: как далеко можно зайти в обычном ChatGPT' },
    shortTitle: { en: 'Coding without Codex', ru: 'Код без Codex' },
    notificationTitle: { en: 'New note on coding in regular ChatGPT', ru: 'Новая заметка о разработке в обычном ChatGPT' },
    description: {
  ...
  {
    slug: 'visual-novel-ai-game', date: '2026-07-15', notificationId: '2026-07-15-visual-novel-ai-game',
    href: './visual-novel-ai-game.html', url: './blog/posts/visual-novel-ai-game.html',
    type: { en: 'AI game development', ru: 'Разработка AI-игры' },
    title: {
    ...
    shortTitle: { en: 'Starting Visual Novel', ru: 'Начинаю Visual Novel' },
    notificationTitle: { en: 'A new AI visual novel project', ru: 'Новый проект AI-визуальной новеллы' },
    description: {
...
window.BLOG_SITE_NOTIFICATIONS = [
  {
    ...
    date: '2026-06-28',
    type: { en: 'Update', ru: 'Обновление' },
    title: { en: 'Living portfolio layer', ru: 'Живой слой портфолио' },
    text: {
