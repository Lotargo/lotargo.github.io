/*
  ...
  - image: put a local path like "./assets/img/sonata.png" or a remote URL.
  - landingUrl: public landing/case-study/demo page.
  - repoUrl: public repository or evidence dossier.
  - Empty image fields intentionally show brutalist placeholders.
*/
...
window.PORTFOLIO_PROJECTS = [
  {
    ...
    index: "01",
    category: "AI",
    status: "Closed-core research / public evidence dossier",
  ...
  },
  {
    ...
    index: "03",
    category: "AGENTIC",
    status: "Public local-first agentic workspace",
  ...
  },
  {
    ...
    index: "04",
    category: "RUNTIME",
    status: "Public static runtime experiment",
  ...
  },
  {
    ...
    index: "07",
    category: "VERIFY",
    status: "Public reproducibility lab",
    description: "Verification-oriented experiments around retrieval integrity, analytical correctness, adversarial rejection, singular states, and SAT-style checks.",
    proof: "Repository, reports, reproducibility packs",
    stack: "Python, symbolic checks, numerical verification, SAT/DPLL/CDCL",
    image: "",
  ...
  },
  {
    ...
    description: "Minimal two-stage LLM routing pipeline implemented with low-level constraints to test how little runtime support is needed for routing logic.",
    proof: "Repository, architecture probe, unusual implementation stack",
  ...
  },
  {
    ...
    description: "Observable multi-agent society sandbox for roles, asymmetric perception, constrained communication, repeatable scenarios, and emergent behavior.",
    proof: "Repository, prototype description, agent-sandbox structure",
